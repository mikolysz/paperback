...
- MathML formulas rendered as AsciiMath through MathCAT, with formula navigation and a view of the original MathML; output preferences are not implemented yet
