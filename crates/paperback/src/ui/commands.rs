...
pub static COMMANDS: &[Command] = &[
	...
	Command {
		action: ActionId::PreviousMath,
		// TRANSLATORS: Menu item in the Go menu to move to the previous formula.
		label: || t("Previous For&mula"),
		help: None,
		enable: Enable::HasDocument,
		behavior: Behavior::Navigate { target: MarkerNavTarget::Math, next: false },
	},
	Command {
		action: ActionId::NextMath,
		// TRANSLATORS: Menu item in the Go menu to move to the next formula.
		label: || t("Next For&mula"),
		help: None,
		enable: Enable::HasDocument,
		behavior: Behavior::Navigate { target: MarkerNavTarget::Math, next: true },
	},
	Command {
